...
pensar estrategias de desarrollo. En materia de política túristica, como
...
poligonos correspondientes a la región, por ejemplo).
...
\item
  ...
  para la latitud y otra para la longitud. Para represetnar líneas y
